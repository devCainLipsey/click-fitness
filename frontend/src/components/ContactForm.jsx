...
const ContactForm = () => {
  ...
  return (
    <div className=" h-full max-w-lg mx-auto bg-black bg-opacity-75 shadow-md rounded px-8 pt-6 pb-8 mb-4 border-2 border-red-500">
      ...
      <div className="flex items-center justify-center">
        <button
          className=" bg-slate-700 hover:bg-red-600 text-white  font-bold focus:outline-none focus:shadow-outline py-3 px-6 rounded inline-block mt-4 transition duration-200  "
          type="button"
